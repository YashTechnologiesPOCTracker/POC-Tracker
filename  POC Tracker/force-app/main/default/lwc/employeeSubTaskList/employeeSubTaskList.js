...
export default class EmployeeSubTaskList extends NavigationMixin(LightningElement) {
    @api parentId;
    //@api profileName;
    //parentId;
    @api subcompId;
    ...
    connectedCallback() {
        ...
        fireEvent(this.pageRef, 'subTaskEmpReportChart', reportData);
    ...
    // @api handleRefresh() {
    //     console.log('Parent mathods called child');
    ...
    updateProgress() {
        ...
        if (this.aggregateProgress > 90) {
            console.log('Aggregated Progress is ' + this.aggregateProgress);
            fields[ID_FIELD.fieldApiName] = this.parentId;
            fields[PROGRESS_FIELD.fieldApiName] = 85;
        } else {
            fields[ID_FIELD.fieldApiName] = this.parentId;
